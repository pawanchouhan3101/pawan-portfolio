...
export default function ProjectShowcase(props: ProjectShowcaseProps) {
  ...
  const activeProject = props.projects[currentImage];
    ...
    <section className="overflow-hidden px-6 py-32 sm:px-14 md:px-20">
      <div className="relative mx-auto max-w-7xl">
        <div className="mb-10 lg:hidden">
          <div className="overflow-hidden rounded-lg border border-zinc-300 shadow-lg dark:border-accent/20 dark:shadow-lg dark:shadow-emerald-400/5">
            <Image
